    ...
    let getUserMedia = () => {
        if ((video && videoAvailable) || (audio && audioAvailable)) {
            navigator.mediaDevices
                ...
                .then(getUserMediaSuccess) //TODO: getUserMediaSuccess should handle the stream
                .then((stream) => {})
                .catch((e) => console.log(e));
        } else {
            try {
                ...
                connections[id]
                    ...
                    .then(() => {
                        socketRef.current.emit(
                            ...
                            id,
                            JSON.stringify({
                                sdp: connections[id].localDescription, //sdp: session description protocol
                            })
                        );
                    })
                    .catch((e) => console.log(e));
